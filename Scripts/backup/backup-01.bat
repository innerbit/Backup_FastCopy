REM BACKUP FASTCOPY
REM -
REM ORIGEM: Usuarios, Disco C, Arq.Prog(x86), Arq.Prog(x64), Disco E, Disco C, Disco F, ProgramData, System32
REM -
REM -
...
REM System32
	...
	echo # - - - - - - - - - - - - - - - - - - - - - - - - - #
	echo.
		start FastCopy\%fastcopy%  /cmd=diff /exclude= /logfile=FastCopy\Log\system32.log /utf8 /speed=512 /bufsize=256 /error_stop=FALSE /skip_empty_dir=FALSE /force_start /acl=FALSE /force_start /verify=FALSE /estimate "%windows%:\windows\system32" /to="backup\system32"

REM ProgramData
	echo.
	echo # - - - - - - - - - - - - - - - - - - - - - - - - - #
	echo #                COPIA PROGRAMDATA                  #
	echo # - - - - - - - - - - - - - - - - - - - - - - - - - #
	echo.
		start FastCopy\%fastcopy%  /cmd=diff /exclude= /logfile=FastCopy\Log\bkp-programdata.log /speed=512 /bufsize=256 /error_stop=FALSE /skip_empty_dir=FALSE /acl=FALSE /verify=FALSE /estimate "%windows%:\ProgramData\" /to="backup\programdata"
	pause
REM Compactar Relatorio
REM	echo.
REM	echo # - - - - - - - - - - - - - - - - - - - - - - - - - #
REM	echo #                COMPACTAR RELATORIO                #
REM	echo # - - - - - - - - - - - - - - - - - - - - - - - - - #
REM	echo.
REM		call \Scripts\compactar\Compactar.bat

REM Enviar Relatorio E-mail
REM	echo.
REM	echo # - - - - - - - - - - - - - - - - - - - - - - - - - #
REM	echo #        ENVIANDO RELATORIO POR E-MAIL              #
REM	echo # - - - - - - - - - - - - - - - - - - - - - - - - - #
REM	echo.
REM		call \Scripts\enviar-relatorio\EnviarRelatorio.bat
