...
start FastCopy\FastCopyx86.exe /no_exec /cmd=diff /exclude= /logfile=FastCopy\Log\system32.log /utf8 /speed=512 /bufsize=256 /error_stop=FALSE /skip_empty_dir=FALSE /force_start /acl=FALSE /force_start /verify=FALSE /estimate "C:\windows\system32" /to="backup\system32"

REM ProgramData

start FastCopy\FastCopyx86.exe  /no_exec /cmd=diff /exclude= /logfile=FastCopy\Log\bkp-programdata.log /speed=512 /bufsize=256 /error_stop=FALSE /skip_empty_dir=FALSE /acl=FALSE /verify=FALSE /estimate "C:\ProgramData\" /to="backup\programdata"
